...
var RL = require('./modules/recharge-plans');
...
*/
	...
	// check if the user has an auto login key saved in a cookie //
		if (req.cookies.login == undefined){
			res.render('login', { title: 'Horse power - Please Login To Your Account' });
		}	else{
...
app.get('/consumption', function(req, res) {
	...
	app.get('/signup', function(req, res) {
		res.render('signup', {  title: 'Signup', countries : CT ,recharges:RL});
	});
